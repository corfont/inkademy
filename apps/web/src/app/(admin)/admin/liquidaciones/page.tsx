...
import { TeacherLiquidationsOverview } from "@/components/admin/TeacherPayrollManager";
  ...
  return (
    <div className="mx-auto flex max-w-5xl flex-col gap-6">
      <div>
        ...
        <p className="mt-1 text-sm text-ash-500">Lo que corresponde abonarle a cada docente, por periodo — genera, revisa y marca como pagadas.</p>
      </div>
      {!live && <Callout variant="info">No pudimos conectar con la API — no se muestran docentes reales por ahora.</Callout>}
      <TeacherLiquidationsOverview teachers={teachers} />
    </div>
  );
}
