  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <Callout variant="info">
        La respuesta automática de la IA a sugerencias se configura aparte, en <strong>/admin/configuracion</strong> — junto con las demás
        opciones sensibles (comisiones, IGV, detracción), para que no se cambien por equivocación desde esta pantalla.
      </Callout>
